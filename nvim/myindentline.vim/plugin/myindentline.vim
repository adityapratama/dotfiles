if exists('g:loaded_myindentline')
  finish
endif

let g:loaded_myindentline = 1

let g:pretty_indent_namespace = nvim_create_namespace('indent_blankline')
...
function! PrettyIndent()
    ...
    while 1
        ...
        if l:indent > 0
            ...
            \   l:match - 1,
            \   [[repeat(repeat(' ', &shiftwidth - 1) . '│', (l:indent / &shiftwidth) -  1 ), 'Conceal']],
            \   {}
            \)
        endif
    endwhile
